...
fzscd_color_map = {
    ...
    1: (0, 100, 0),        # cropland → tree
    2: (0, 112, 192),      # cropland → water
    3: (112, 128, 144),    # cropland → building
    4: (200, 0, 0),        # cropland → road
    5: (160, 82, 45),      # cropland → ground
}
...
if __name__ == "__main__":
    # 设置输入输出路径
    input_dir = "/home/zyy/SCTDM_Net/results/FZSCD/test"
    output_dir = "/home/zyy/SCTDM_Net/results/FZSCD/label_rgb"
    
    # 执行转换
    convert_labels(input_dir, output_dir, fzscd_color_map)